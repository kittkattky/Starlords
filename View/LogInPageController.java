...
public class LogInPageController implements Initializable {
     ...
     */
    @FXML
    public void handleButtonAction(MouseEvent _event) {

        if (_event.getSource() == this.signIn) {
     ...
     */
    @FXML
    public void handleButtonAction2(MouseEvent _event) throws IOException{

        if (_event.getSource() == this.signUp) {
                    Node node = (Node) _event.getSource();
                    Stage stage = (Stage) node.getScene().getWindow();
                    stage.close();
    ...
    private String logIn() {
        ...
        String email1 = this.username.getText();
