...
public class FXMLDocumentController implements Initializable {
    ...
    /**
     * When the search for cuisines button is clicked, this method handles that action event
     * @param event 
     */
    @FXML
    ...
    /**
     * This method is called when the user clicks the "Search for Cuisines" button.
     * A call to the api is made through the restaurant model, and the information 
     * from the api is returned as a map.
     * Each element from the map is cycled through and added to the listView.
     */
     ...
     * 
     * The Cuisine ID Map within the restaurant model object was populated upon the initial call of 
     * the "loadCusinesByLocation" method, it contains all cuisines (key) and cuisine IDs (value).
     * 
     * Thus the ID of the cuisine chosen by the user can be found by passing it as a key to the cuisine ID Map.
     * 
     * The id of the cuisine is set through the restaurant model using a set method
     */
    @FXML
    ...
    /**
     * When an area of list view is clicked, meaning the user selects a cuisine, this method sets isSelected to true.
     */
